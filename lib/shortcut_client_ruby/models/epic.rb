  ...
  class Epic
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Shortcut::Epic` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Shortcut::Epic`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @productboard_plugin_id.nil?
        invalid_properties.push('invalid value for "productboard_plugin_id", productboard_plugin_id cannot be nil.')
      end
      ...
      if @productboard_url.nil?
        invalid_properties.push('invalid value for "productboard_url", productboard_url cannot be nil.')
      end

      if @planned_start_date.nil?
        invalid_properties.push('invalid value for "planned_start_date", planned_start_date cannot be nil.')
      end
      ...
      if @productboard_id.nil?
        invalid_properties.push('invalid value for "productboard_id", productboard_id cannot be nil.')
      end
      ...
      if @productboard_name.nil?
        invalid_properties.push('invalid value for "productboard_name", productboard_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @productboard_plugin_id.nil?
      return false if @started_at.nil?
      return false if @completed_at.nil?
      return false if @name.nil?
      return false if @completed.nil?
      return false if @comments.nil?
      return false if @productboard_url.nil?
      return false if @planned_start_date.nil?
