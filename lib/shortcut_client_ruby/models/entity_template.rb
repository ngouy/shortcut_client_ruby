  ...
  class EntityTemplate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Shortcut::EntityTemplate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Shortcut::EntityTemplate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'story_contents')
        self.story_contents = attributes[:'story_contents']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @story_contents.nil?
        invalid_properties.push('invalid value for "story_contents", story_contents cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @story_contents.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          story_contents == o.story_contents
    end
    ...
    def hash
      [entity_type, id, created_at, updated_at, name, author_id, last_used_at, story_contents].hash
    end
