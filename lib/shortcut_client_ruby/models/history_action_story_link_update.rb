...
module Shortcut
  ...
  class HistoryActionStoryLinkUpdate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Shortcut::HistoryActionStoryLinkUpdate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Shortcut::HistoryActionStoryLinkUpdate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      action_validator = EnumAttributeValidator.new('Object', ['update'])
      return false unless action_validator.valid?(@action)
      return false if @verb.nil?
      verb_validator = EnumAttributeValidator.new('Object', ['blocks', 'duplicates', 'relates to'])
    ...
    def action=(action)
      validator = EnumAttributeValidator.new('Object', ['update'])
    ...
    def verb=(verb)
      validator = EnumAttributeValidator.new('Object', ['blocks', 'duplicates', 'relates to'])
    ...
    def hash
      [id, entity_type, action, verb, subject_id, object_id, changes].hash
    end
