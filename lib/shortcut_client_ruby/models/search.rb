...
module Shortcut
  class Search
    ...
    def valid?
      ...
      include_validator = EnumAttributeValidator.new('Object', ['cursors'])
      return false unless include_validator.valid?(@include)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] include Object to be assigned
    def include=(include)
      validator = EnumAttributeValidator.new('Object', ['cursors'])
      unless validator.valid?(include)
        fail ArgumentError, "invalid value for \"include\", must be one of #{validator.allowable_values}."
      end
      @include = include
    end
