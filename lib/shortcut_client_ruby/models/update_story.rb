...
module Shortcut
  class UpdateStory
    ...
    def self.openapi_types
      {
        ...
        :'pull_request_ids' => :'Array<Integer>',
        :'story_type' => :'String',
        :'move_to' => :'String',
    ...
    # Custom attribute writer method with validation
    # @param [Object] pull_request_ids Value to be assigned
    def pull_request_ids=(pull_request_ids)
      @pull_request_ids = pull_request_ids
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] branch_ids Value to be assigned
    def branch_ids=(branch_ids)
      @branch_ids = branch_ids
    end

    # Custom attribute writer method with validation
    # @param [Object] commit_ids Value to be assigned
    def commit_ids=(commit_ids)
      @commit_ids = commit_ids
    end
