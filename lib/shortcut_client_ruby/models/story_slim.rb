...
module Shortcut
  ...
  class StorySlim
    ...
    attr_accessor :num_tasks_completed
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Shortcut::StorySlim` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Shortcut::StorySlim`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'num_tasks_completed')
        self.num_tasks_completed = attributes[:'num_tasks_completed']
      end
      ...
      if attributes.key?(:'comment_ids')
        if (value = attributes[:'comment_ids']).is_a?(Array)
          self.comment_ids = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @task_ids.nil?
        invalid_properties.push('invalid value for "task_ids", task_ids cannot be nil.')
      end
      ...
      if @num_tasks_completed.nil?
        invalid_properties.push('invalid value for "num_tasks_completed", num_tasks_completed cannot be nil.')
      end
      ...
      if @linked_file_ids.nil?
        invalid_properties.push('invalid value for "linked_file_ids", linked_file_ids cannot be nil.')
      end
      ...
      if @comment_ids.nil?
        invalid_properties.push('invalid value for "comment_ids", comment_ids cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @num_tasks_completed.nil?
      ...
      return false if @linked_file_ids.nil?
      return false if @deadline.nil?
      return false if @stats.nil?
      return false if @comment_ids.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          file_ids == o.file_ids &&
          num_tasks_completed == o.num_tasks_completed &&
