...
module Shortcut
  ...
  class HistoryActionPullRequest
    ...
    def valid?
      ...
      action_validator = EnumAttributeValidator.new('String', ["open", "update", "reopen", "close", "sync", "comment"])
    ...
    def action=(action)
      validator = EnumAttributeValidator.new('String', ["open", "update", "reopen", "close", "sync", "comment"])
