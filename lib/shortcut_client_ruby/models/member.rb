...
module Shortcut
  ...
  class Member
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('Object', ['partial', 'full', 'disabled', 'imported'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('Object', ['partial', 'full', 'disabled', 'imported'])
