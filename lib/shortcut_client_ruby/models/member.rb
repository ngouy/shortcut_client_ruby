...
module Shortcut
  ...
  class Member
    ...
    attr_accessor :created_without_invite
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Shortcut::Member` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Shortcut::Member`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'created_without_invite')
        self.created_without_invite = attributes[:'created_without_invite']
      end
    ...
    def list_invalid_properties
      ...
      if @created_without_invite.nil?
        invalid_properties.push('invalid value for "created_without_invite", created_without_invite cannot be nil.')
      end
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ["partial", "full", "disabled", "imported"])
      return false unless state_validator.valid?(@state)
      return false if @created_without_invite.nil?
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["partial", "full", "disabled", "imported"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          created_without_invite == o.created_without_invite &&
    ...
    def hash
      [role, entity_type, disabled, state, updated_at, created_without_invite, group_ids, id, profile, created_at, replaced_by].hash
    end
