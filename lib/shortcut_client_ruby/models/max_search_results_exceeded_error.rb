...
module Shortcut
  ...
  class MaxSearchResultsExceededError
    ...
    def valid?
      ...
      error_validator = EnumAttributeValidator.new('Object', ['maximum-results-exceeded'])
      return false unless error_validator.valid?(@error)
      return false if @message.nil?
      return false if @maximum_results.nil?
      maximum_results_validator = EnumAttributeValidator.new('Object', [1000])
    ...
    def error=(error)
      validator = EnumAttributeValidator.new('Object', ['maximum-results-exceeded'])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] maximum_results Object to be assigned
    def maximum_results=(maximum_results)
      validator = EnumAttributeValidator.new('Object', [1000])
      unless validator.valid?(maximum_results)
        fail ArgumentError, "invalid value for \"maximum_results\", must be one of #{validator.allowable_values}."
      end
