...
module Shortcut
  ...
  class EpicStats
    ...
    def list_invalid_properties
      ...
      if @last_story_update.nil?
        invalid_properties.push('invalid value for "last_story_update", last_story_update cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @last_story_update.nil?
